...
//     std::cout << "Learning Time: " << end - start << std::endl;

//     start = omp_get_wtime();
//     BOOL result = matcher->Match();
//     end = omp_get_wtime();
//     std::cout << "Match Time: " << end - start << std::endl;
...
//     }
//     cv::resize(src, src, Size(src.cols/4, src.rows/4));
//     // cv::namedWindow("Display frame", WINDOW_NORMAL);
//     // cv::imshow("Display frame", src);
//     cv::waitKey(0);
