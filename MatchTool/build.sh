...
clang++ main.cpp -o ./out/main -g -O3 -fopenmp  -march=native -I/usr/local/include/opencv4 -L/usr/local/lib -lopencv_imgproc -lopencv_core -lopencv_highgui -lopencv_imgcodecs
